    ...
    <div className="mb-6 sm:mb-8">
      ...
      <fieldset className="border border-gray-200 rounded-md p-3 sm:p-4">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 mt-4 pt-4 border-t border-gray-200">
          {/* Fixed Add Item button with proper hover area */}
          <button
            type="button"
            className="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            onClick={onAdd}
          >
            Add Item
          </button>
